...
class DoubleLinkedListNode<Item>  {
    ...
    private void addBetween(Item item, DLLNode current, DLLNode replacement){ // item, prev, next
    ...
    public void print()throws EmptyQueueException {
        if (isEmpty()) {
            ...
            System.out.println("the Q size is :" + getSize());  // the size is 1 when first initialized cuz 1 Sentinel node
        }
    }
}