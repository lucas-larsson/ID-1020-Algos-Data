...
public class BST<Key extends Comparable<Key>, Value> {
     ...
     * a method to print the content of a node list in reverse order to the counsel suing the standard
    ...
    private void printInReverseOrder(Node n){
        ...
        printInReverseOrder(n.right);
        System.out.println(n.key);
        printInReverseOrder(n.left);
    }
    /**
     * Author : LUCAS LARSSON
     * a method to print the content of a node list in Alphabetic order to the counsel suing the standard
     * "System.out.println" function
     */
